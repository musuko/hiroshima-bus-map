...
// ===== 外部GTFSドメイン =====
window.GTFS_DOMAINS = {
  BUSIT: "https://gtfs-st.busit.jp/api/",
  BUSVISION: "https://bus-vision.jp/gtfs_v2/"
};
// 1. APIの基点URL
...
window.APP_CONFIG = {
    ...
    COMPANIES: {
        ...
        etajima: { color: '#000000', textColor: '#000000' },
        chugokubus_ext: { color: '#000000', textColor: '#000000' },
        tomotetsu: { color: '#000000', textColor: '#000000' },
        ikasa: { color: '#000000', textColor: '#000000' },
